...
<body class="hold-transition login-custom" style="background:url('<?php echo base_url(); ?>assets/image/background_web.png') no-repeat center center fixed ;-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; overflow:hidden;">
<div class="login-box">
  <div class="login-logo-img">
		<img src="<?php echo base_url(); ?>assets/image/bulok/logo_hitam.png" width="25%">
  </div>
  <!-- /.login-logo -->
  ...
  <div class="card transbox-login"></div>
     ...
     <form action="<?php echo base_url('Login/cek_data') ?>" method="post" id="login-form" autocomplete="off">
        <div class="input-group mb-3 form-icons">
              ...
              <input type="text" class="form-control-login" name="name" placeholder="Username">
        </div>
        <div class="input-group mb-3 form-icons">
        	  <img src="<?php echo base_url(); ?>assets/image/password.png" style="margin: 7px 0 0 5px; width:8%; height:8%;"/>
              <input type="password" class="form-control-login" name="password" placeholder="Password">
        </div>
        <div class="input-group mb-2"></div>
        <div class="row">
          <div class="col-8">Sign in</div>
          <!-- /.col -->
          <div class="col-4">
            <button
        data-sitekey="6LdlTsAZAAAAAJeHsPDMNBM1LxgEAcb6q84CMv53" 
        data-callback='onSubmit' 
        data-action='submit' class="g-recaptcha button-login"><img src="<?php echo base_url(); ?>assets/image/login.png" width="70%"></button>
        <br><a  href="<?php echo base_url('Login/ForgotPassword') ?>">
        Forgot Password
      </a>
          </div>
          <!-- /.col -->
