    ...
    <div class="row mb-2">
      ...
      <div class="col-lg-8">
        <div class="row float-right">
          <a href="<?php echo base_url('Korlap/addKorlap') ?>">
            ...
            <div class="tab-content" id="custom-tabs-one-tabContent">
              <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                <div class="col-lg-12">
                  <div class="row">
                    <div class="col-md-3">
                      <input type="text" class="form-control form-control-sm" id="name_korlap" name="name_korlap" placeholder="Name Korlap">
                    </div>
                    <div class="col-md-2">
                      <button type="submit" class="btn btn-custon-four btn-default btn-sm" id="search-data-by-name-korlap">
                ...
                <table class="table table-striped projects" id="data">
                  <thead>
                    <tr>
                      ...
                      <th data-field="name" data-editable="true" class="police_number">Nama Arko</th>
                      <th data-field="name" data-editable="true" class="police_number">NIK</th>
                      <th data-field="email" data-editable="true" class="capacity">Phone</th>
...
<script src="<?php echo base_url(); ?>assets/js-data/korlap/get-index.js" id="date" data-start="<?php echo date('d-m-Y', strtotime($start)); ?>" data-end="<?php echo date('d-m-Y', strtotime($end)); ?>"></script>
