				...
				<div class="col-md-12">
					...
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Add Expedition</h3>
						</div>
						<form id="add-product" role="form" action="<?php echo base_url('Expedition/add_data') ?>" method="post" enctype="multipart/form-data" class="add-expedition" autocomplete="off">
							<div class="card-body">
								<div class="row">
									...
									<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
										<div class="input-mark-inner mg-b-22">
											<input name="name_expedition" type="text" class="form-control" placeholder="Name Expedition">
											<small class="form-text text-muted">
												<?php echo form_error('name_expedition');  ?>
											</small>
										</div>
									</div>
									<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
								...
								<div class="row">
									...
									<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
										<div class="input-mark-inner mg-b-22">
											<a href="<?php echo base_url('Truck') ?>" class="btn btn-danger" style="margin-left: 5px;">Cancel
											</a> 
