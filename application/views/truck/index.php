    ...
    <div class="row mb-2">
      ...
      <div class="col-lg-9">
        <div class="row float-right">
          <a href="<?php echo base_url('Truck/addTruck') ?>">
            <button type="button" class="btn btn-default btn-sm">
              <i class="fa fa-add" aria-hidden="true"></i> Add Truck
            </button>
          </a>
        </div>
      </div>
                ...
                <table class="table table-striped projects" id="data">
                  <thead>
                    <tr>
                      ...
                      <th data-field="name" data-editable="true" class="police_number">Police Number</th>
...
<script src="<?php echo base_url(); ?>assets/js-data/truck/get-index.js" id="date" data-start="<?php echo date('d-m-Y', strtotime($start)); ?>" data-end="<?php echo date('d-m-Y', strtotime($end)); ?>"></script>
