			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="card card-primary">
						...
						<form id="add-product" action="<?php echo base_url('Truck/update') ?>" method="post" enctype="multipart/form-data" class="add-department" autocomplete="off">
							<div class="card-body">
								<p>
									<div class="row">
										...
										<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
											<div class="input-mark-inner mg-b-22"> <input name="police_number" type="text" class="form-control" placeholder="Police Number" value="<?php echo $data->no_police; ?>"> <small class="form-text text-muted"><?php echo form_error('police_number');  ?></small> </div>
										</div>
									</div>
									<p>
										<div class="row">
											<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
												<div class="input-mark-inner mg-b-22"><input type="hidden" class="form-control" name="id" value="<?php echo $data->id; ?>" /> </div>
											</div>
										</div>
										<p>
											<div class="row">
