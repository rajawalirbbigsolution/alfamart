    ...
    <div class="row mb-2">
      ...
      <!-- <div class="col-lg-10">
                ...
                <div class="row float-right">
                    ...
                    <a href="<?php echo base_url('Schedule/getAdd'); ?>">

                        <button type="button" class="btn btn-default btn-sm">

                            <i class="fa fa-add" aria-hidden="true"></i> Add Schedule
                  ...
                  <table class="table table-striped projects" id="data">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th data-field="code_product" data-editable="true" class="code_product">Korlap</th>

                        <th data-field="email" data-editable="true" class="name_product">Kabupaten</th>

                        <th data-field="email" data-editable="true" class="variant">Kecamatan</th>
                        <th data-field="email" data-editable="true" class="variant">Kelurahan</th>
                        <th data-field="email" data-editable="true" class="variant">RW</th>
                        <th data-field="email" data-editable="true" class="variant">RT</th>

                        <!-- <th data-field="phone" data-editable="true" class="berat">image</th> -->

                        <th data-field="phone" data-editable="true" class="berat">Date</th>
                        <th data-field="phone" data-editable="true" class="berat">Remaks</th>
...
<script src="<?php echo base_url(); ?>assets/js-data/schedule/get-index.js" id="date" data-start="<?php echo date('d-m-Y', strtotime($start)); ?>" data-end="<?php echo date('d-m-Y', strtotime($end)); ?>"></script>
